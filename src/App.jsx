  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <style>
        ...
        <div class="footer">
          Report generated by YouTube Analytics AI Assistant &nbsp;|&nbsp; Powered by OpenAI API<br/>
  ...
  <div style={{ maxWidth: 640, margin: "0 auto" }}>
    ...
    <div style={{
      ...
      <p style={{ color: theme.textMuted, fontSize: 13, lineHeight: 1.7 }}>
        This app uses the <strong style={{ color: theme.text }}>OpenAI ChatGPT API</strong> to power the conversational analytics.
        ChatGPT analyzes your YouTube data and generates insights, answers questions, and creates reports.
      </p>
      <div style={{
        display: "flex", alignItems: "center", gap: 10, padding: 14,
        ...
        <span style={{ color: theme.blue, fontSize: 13, fontWeight: 500 }}>OpenAI API: Active</span>
      </div>
    </div>
  </div>
);
